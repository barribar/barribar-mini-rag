...
class AllTelegramKotobAr(TelegramSQLAlchemyBase):
    __tablename__ = "all_telegram_kotob_ar"
    ...
    # ForeignKey
    maktaba      = Column(Integer, ForeignKey("all_telegram_maktaba_ar.maktaba_id"), primary_key=True)

    # Unicité composite kitab_id + kitab_link
    __table_args__ = (
        UniqueConstraint("kitab_id", "kitab_link", name="uq_ar_kitab_id_link"),
    )

    # Relation vers AllTelegramMaktabaAr
    maktaba_ar  = relationship("AllTelegramMaktabaAr", back_populates="kotob_ar")
