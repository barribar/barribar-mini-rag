...
from routes.schemes.fileUtilities  import (ScanDuplicatesResponse, DuplicateFile, 
                            ...
                            FoundFile, SearchFilesResponse, UnlockPDFResponse, 
                            UnlockPDFResult, ConvertPDFResponse, ConvertPDFResult)
...
@fileUtilities_router.post("/unlockPDF", response_model=UnlockPDFResponse)
